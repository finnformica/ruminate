 ...
 * "Block types") and then the note types; `has:`/`no:` the countable things;
 * `sort:` is left to the typed form (`sort:title:desc`).
 */
export const STATIC_QUALIFIER_OPTIONS: Readonly<Record<string, readonly QualifierOption[]>> = {
  type: [
    ...
    { value: "h4", description: "heading level 4" },
    { value: "h5", description: "heading level 5" },
    { value: "h6", description: "heading level 6" },
