...
| ---------------------- | ----- | ------------------------------------------------------------------------------------------------- |
| `--border-radius-sm`   | 4px   | inline chips: transclusions, keys                                                                 |
| `--border-radius-base` | 8px   | line surfaces (block/title highlight), controls, the inline code chip (a soft pill one line tall) |
