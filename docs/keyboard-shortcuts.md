...
**Recent** notes (pinned first, then the five most recently edited, read
off the graph and stored nowhere) — are the same block editor, browsed,
under the same count line as the notes page. The
