...
The rows are just the values, capitalised (a block type beside its glyph; a sort spelt out, "Title, A to Z"): no header, no glosses, no key hints. ↑/↓ move, ↵ or Tab pick, Esc closes.
