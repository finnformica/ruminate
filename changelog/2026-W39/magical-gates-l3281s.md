...
- A bar for the selected blocks. Select more than one block and a bar rises at the bottom of the window with the count and an **Actions** menu with everything the keys can do to a selection — turn into, duplicate, indent, outdent, move up or down, copy, cut and remove — each acting on every selected block. It greys what the selection cannot take, and sinks away when the selection collapses back to one block.
