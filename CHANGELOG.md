...
- Suggestions for qualifiers as you type. Type `type:`, `in:`, `tag:`, `has:` or `no:` into the search box on the notes or tags page, or into <kbd>⌘</kbd> <kbd>K</kbd>, and a picker opens with what can go there — the block and note types, your notes by name (the open note first), your tags with their counts. Keep typing to narrow it, <kbd>↑</kbd>/<kbd>↓</kbd> to move, <kbd>↵</kbd> or <kbd>Tab</kbd> to pick, <kbd>Esc</kbd> to leave what you typed.
