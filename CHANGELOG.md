...
- An image block sits flush. The picture has no frame or padding of its own and starts where the row does rather than 15px in, where a bullet would be; it fills the row's width when it is wide enough and centres itself when it is not. A picture with no caption no longer leaves an empty line beneath it, and a caption is centred under its picture.
