...
- Fixed blocks that could get permanently stuck collapsed: neither the expand button nor the keyboard shortcut would open them, though zooming in still showed their contents. Affected blocks now open on the next click.
